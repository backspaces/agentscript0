(function() {
  var AgentSet, Animator, Color, ColorMaps, Evented, Link, Links, Model, Patch, Patches, Shapes, Turtle, Turtles, Util, colorMixin, shapes, u, util,
  ...
  Model = (function() {
    ...
    Model.prototype.setRootVars = function() {
      ...
      window.ac = this.Turtle;
      window.lc = this.Link;
      window.ps = this.patches;
      window.as = this.turtles;
      window.ls = this.links;
      window.p0 = this.patches[0];
      window.a0 = this.turtles[0];
