(function() {
  ...
  ABM.util = u = {
    ...
    imageToCtxDownStepped: function(img, tw, th) {
      ...
      steps = Math.ceil(u.log2((w / tw) > (h / th) ? w / tw : h / th));
  ...
  ABM.AgentSet = (function(_super) {
    ...
    AgentSet.prototype.getProp = function(prop) {
      return ABM.util.aProp(this, prop);
    };
  ...
  ABM.Agent = (function() {
    ...
    Agent.prototype.draw = function(ctx) {
      ...
      if ((this.sprite != null) || this.breed.useSprites) {
        ...
        ABM.shapes.draw(ctx, shape, this.x, this.y, this.size, rad, this.color, this.strokeColor);
      }
      if (this.label != null) {
    ...
    Agent.prototype.patchAtHeadingAndDistance = function(h, d) {
      var x, y, _ref;
      _ref = u.polarToXY(d, h), x = _ref[0], y = _ref[1];
      return this.patchAt(x, y);
    };
  ...
  ABM.Model = (function() {
    ...
    function Model(divOrOpts, size, minX, maxX, minY, maxY, isTorus, hasNeighbors, isHeadless) {
      ...
      this.Patches = this.extend(ABM.Patches);
      this.Patch = this.extend(ABM.Patch);
      this.Agents = this.extend(ABM.Agents);
      this.Agent = this.extend(ABM.Agent);
      this.Links = this.extend(ABM.Links);
      this.Link = this.extend(ABM.Link);
    ...
    Model.prototype.extend = function(aClass) {
